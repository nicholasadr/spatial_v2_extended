...
CASADI_SYMBOL_EXPORT int g_gen(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  return casadi_f0(arg, res, iw, w, mem);
}

CASADI_SYMBOL_EXPORT int g_gen_alloc_mem(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT int g_gen_init_mem(int mem) {
  return 0;
}

CASADI_SYMBOL_EXPORT void g_gen_free_mem(int mem) {
}

CASADI_SYMBOL_EXPORT int g_gen_checkout(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT void g_gen_release(int mem) {
}

CASADI_SYMBOL_EXPORT void g_gen_incref(void) {
}

CASADI_SYMBOL_EXPORT void g_gen_decref(void) {
}

CASADI_SYMBOL_EXPORT casadi_int g_gen_n_in(void) { return 4;}

CASADI_SYMBOL_EXPORT casadi_int g_gen_n_out(void) { return 1;}

CASADI_SYMBOL_EXPORT casadi_real g_gen_default_in(casadi_int i) {
  switch (i) {
    default: return 0;
  }
}

CASADI_SYMBOL_EXPORT const char* g_gen_name_in(casadi_int i) {
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    case 2: return "i2";
...
CASADI_SYMBOL_EXPORT const char* g_gen_name_out(casadi_int i) {
  switch (i) {
    case 0: return "o0";
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT const casadi_int* g_gen_sparsity_in(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT const casadi_int* g_gen_sparsity_out(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT int g_gen_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 4;
  if (sz_res) *sz_res = 1;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 0;
...
#ifdef MATLAB_MEX_FILE
void mex_g_gen(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  casadi_int i;
  int mem;
  casadi_real w[82];
  casadi_int *iw = 0;
  ...
  casadi_real* res[1] = {0};
  if (argc>4) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"g_gen\" failed. Too many input arguments (%d, max 4)", argc);
  if (resc>1) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"g_gen\" failed. Too many output arguments (%d, max 1)", resc);
  if (--argc>=0) arg[0] = casadi_from_mex(argv[0], w, casadi_s0, w+12);
  if (--argc>=0) arg[1] = casadi_from_mex(argv[1], w+2, casadi_s0, w+12);
  if (--argc>=0) arg[2] = casadi_from_mex(argv[2], w+4, casadi_s0, w+12);
  if (--argc>=0) arg[3] = casadi_from_mex(argv[3], w+6, casadi_s0, w+12);
  --resc;
  res[0] = w+8;
  g_gen_incref();
  mem = g_gen_checkout();
  i = g_gen(arg, res, iw, w+12, mem);
  if (i) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"g_gen\" failed.");
  g_gen_release(mem);
  g_gen_decref();
...
void mexFunction(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  if (!buf_ok) {
    mex_g_gen(resc, resv, argc, argv);
    return;
  } else if (strcmp(buf, "g_gen")==0) {
    mex_g_gen(resc, resv, argc-1, argv+1);
    return;
  }
  mexErrMsgTxt("First input should be a command string. Possible values: 'g_gen'");
}
#endif
#ifdef __cplusplus
} /* extern "C" */
