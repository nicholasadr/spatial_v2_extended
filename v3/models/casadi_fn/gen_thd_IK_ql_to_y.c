...
#else
  #define CASADI_PREFIX(ID) gen_thd_IK_ql_to_y_ ## ID
#endif
...
CASADI_SYMBOL_EXPORT int thd_IK_pos(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  return casadi_f0(arg, res, iw, w, mem);
}

CASADI_SYMBOL_EXPORT int thd_IK_pos_alloc_mem(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT int thd_IK_pos_init_mem(int mem) {
  return 0;
}

CASADI_SYMBOL_EXPORT void thd_IK_pos_free_mem(int mem) {
}

CASADI_SYMBOL_EXPORT int thd_IK_pos_checkout(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT void thd_IK_pos_release(int mem) {
}

CASADI_SYMBOL_EXPORT void thd_IK_pos_incref(void) {
}

CASADI_SYMBOL_EXPORT void thd_IK_pos_decref(void) {
}

CASADI_SYMBOL_EXPORT casadi_int thd_IK_pos_n_in(void) { return 1;}

CASADI_SYMBOL_EXPORT casadi_int thd_IK_pos_n_out(void) { return 1;}

CASADI_SYMBOL_EXPORT casadi_real thd_IK_pos_default_in(casadi_int i) {
  switch (i) {
    default: return 0;
  }
}

CASADI_SYMBOL_EXPORT const char* thd_IK_pos_name_in(casadi_int i) {
  switch (i) {
    case 0: return "i0";
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT const char* thd_IK_pos_name_out(casadi_int i) {
  switch (i) {
    case 0: return "o0";
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT const casadi_int* thd_IK_pos_sparsity_in(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT const casadi_int* thd_IK_pos_sparsity_out(casadi_int i) {
  switch (i) {
    case 0: return casadi_s0;
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT int thd_IK_pos_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 1;
  if (sz_res) *sz_res = 1;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 0;
...
#ifdef MATLAB_MEX_FILE
void mex_thd_IK_pos(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  casadi_int i;
  int mem;
  casadi_real w[23];
  casadi_int *iw = 0;
  ...
  casadi_real* res[1] = {0};
  if (argc>1) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"thd_IK_pos\" failed. Too many input arguments (%d, max 1)", argc);
  if (resc>1) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"thd_IK_pos\" failed. Too many output arguments (%d, max 1)", resc);
  if (--argc>=0) arg[0] = casadi_from_mex(argv[0], w, casadi_s0, w+4);
  --resc;
  res[0] = w+2;
  thd_IK_pos_incref();
  mem = thd_IK_pos_checkout();
  i = thd_IK_pos(arg, res, iw, w+4, mem);
  if (i) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"thd_IK_pos\" failed.");
  thd_IK_pos_release(mem);
  thd_IK_pos_decref();
...
void mexFunction(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  if (!buf_ok) {
    mex_thd_IK_pos(resc, resv, argc, argv);
    return;
  } else if (strcmp(buf, "thd_IK_pos")==0) {
    mex_thd_IK_pos(resc, resv, argc-1, argv+1);
    return;
  }
  mexErrMsgTxt("First input should be a command string. Possible values: 'thd_IK_pos'");
}
#endif
#ifdef __cplusplus
} /* extern "C" */
