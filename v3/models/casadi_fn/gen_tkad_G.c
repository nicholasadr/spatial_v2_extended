...
#else
  #define CASADI_PREFIX(ID) gen_tkad_G_ ## ID
#endif
...
CASADI_SYMBOL_EXPORT int tkad_G(const casadi_real** arg, casadi_real** res, casadi_int* iw, casadi_real* w, int mem){
  return casadi_f0(arg, res, iw, w, mem);
}

CASADI_SYMBOL_EXPORT int tkad_G_alloc_mem(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT int tkad_G_init_mem(int mem) {
  return 0;
}

CASADI_SYMBOL_EXPORT void tkad_G_free_mem(int mem) {
}

CASADI_SYMBOL_EXPORT int tkad_G_checkout(void) {
  return 0;
}

CASADI_SYMBOL_EXPORT void tkad_G_release(int mem) {
}

CASADI_SYMBOL_EXPORT void tkad_G_incref(void) {
}

CASADI_SYMBOL_EXPORT void tkad_G_decref(void) {
}

CASADI_SYMBOL_EXPORT casadi_int tkad_G_n_in(void) { return 2;}

CASADI_SYMBOL_EXPORT casadi_int tkad_G_n_out(void) { return 1;}

CASADI_SYMBOL_EXPORT casadi_real tkad_G_default_in(casadi_int i) {
  switch (i) {
    default: return 0;
  }
}

CASADI_SYMBOL_EXPORT const char* tkad_G_name_in(casadi_int i) {
  switch (i) {
    case 0: return "i0";
    case 1: return "i1";
    default: return 0;
...
CASADI_SYMBOL_EXPORT const char* tkad_G_name_out(casadi_int i) {
  switch (i) {
    case 0: return "o0";
    default: return 0;
  }
...
CASADI_SYMBOL_EXPORT const casadi_int* tkad_G_sparsity_in(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT const casadi_int* tkad_G_sparsity_out(casadi_int i) {
  switch (i) {
...
CASADI_SYMBOL_EXPORT int tkad_G_work(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
  if (sz_arg) *sz_arg = 2;
  if (sz_res) *sz_res = 1;
  if (sz_iw) *sz_iw = 0;
  if (sz_w) *sz_w = 0;
...
#ifdef MATLAB_MEX_FILE
void mex_tkad_G(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  casadi_int i;
  int mem;
  casadi_real w[30];
  casadi_int *iw = 0;
  ...
  casadi_real* res[1] = {0};
  if (argc>2) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"tkad_G\" failed. Too many input arguments (%d, max 2)", argc);
  if (resc>1) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"tkad_G\" failed. Too many output arguments (%d, max 1)", resc);
  ...
  tkad_G_incref();
  mem = tkad_G_checkout();
  i = tkad_G(arg, res, iw, w+12, mem);
  if (i) mexErrMsgIdAndTxt("Casadi:RuntimeError","Evaluation of \"tkad_G\" failed.");
  tkad_G_release(mem);
  tkad_G_decref();
...
void mexFunction(int resc, mxArray *resv[], int argc, const mxArray *argv[]) {
  ...
  if (!buf_ok) {
    mex_tkad_G(resc, resv, argc, argv);
    return;
  } else if (strcmp(buf, "tkad_G")==0) {
    mex_tkad_G(resc, resv, argc-1, argv+1);
    return;
  }
  mexErrMsgTxt("First input should be a command string. Possible values: 'tkad_G'");
}
#endif
#ifdef __cplusplus
} /* extern "C" */
